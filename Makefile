...
PUBLISH_CRATES := use-element use-isotope use-chemical-formula use-bond use-oxidation-state use-periodic-table use-atomic-number use-atomic-mass use-electron-shell
DEPENDENT_PUBLISH_CRATES := use-stoichiometry use-reaction use-ion use-compound use-molecule use-molar-mass
